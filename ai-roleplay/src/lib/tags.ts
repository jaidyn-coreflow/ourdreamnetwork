...
export interface TagMeta {
   ...
   * of AI roleplay under this tag), not just keyword-stuff.
   */
...
export const TAG_META: Record<Tag, TagMeta> = {
  vampire: {
    slug: "vampire",
    label: "Vampire",
    seoTitle: "Vampire AI Roleplay Characters",
    seoDescription:
      "Original vampire AI roleplay characters \u2014 blood-pact intrigue, immortal courts, and forbidden bonds. AI roleplay chat.",
    intro:
      "Bloodlines, sieges, and immortal politics. Our vampire AI roleplay stories lean into long-burning tension between courts, where every alliance has a cost and every honest answer is paid for in something older than gold.",
  },
  "dragon-rider": {
    slug: "dragon-rider",
    label: "Dragon Rider",
    seoTitle: "Dragon Rider AI Roleplay Characters",
    seoDescription:
      "Bonded thrones, storm-wing flights, and rider-college rivalry. Original dragon-rider AI roleplay characters \u2014 spicy slow-burn, never explicit.",
    intro:
  ...
  fae: {
    slug: "fae",
    label: "Fae Court",
    seoTitle: "Fae Court AI Roleplay Characters",
    seoDescription:
      "Seasonal courts, ward-stones, and bargains you can't take back. Original fae AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  "slow-burn": {
    slug: "slow-burn",
    label: "Slow-Burn",
    seoTitle: "Slow-Burn AI Roleplay Characters",
    seoDescription:
      "The long, deliberate kind. Slow-burn AI roleplay characters that let tension build across chapters \u2014 suggestive, never explicit.",
    intro:
  ...
  royal: {
    slug: "royal",
    label: "Royal Court",
    seoTitle: "Royal Court AI Roleplay Characters",
    seoDescription:
      "Crown intrigue, masked balls, and empires on a knife edge. Original royal AI roleplay characters \u2014 spicy slow-burn.",
    intro:
      "Thrones, dynasties, and the people who hold them. Our royal AI roleplay stories range from iron-veiled emperors to back-window princesses \u2014 each one built around the kind of person who has to weigh every word against the kingdom listening behind it.",
  },
  warrior: {
    slug: "warrior",
    label: "Warrior",
    seoTitle: "Warrior AI Roleplay Characters",
    seoDescription:
      "Sword and shield, scarred commanders, enemies-to-lovers tension. Original warrior AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  "enemies-to-lovers": {
    ...
    seoTitle: "Enemies-to-Lovers AI Roleplay Characters",
    seoDescription:
      "The trope that built the genre. Original enemies-to-lovers AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  "alpha-male": {
    slug: "alpha-male",
    label: "Alpha Male",
    seoTitle: "Alpha-Male AI Roleplay Characters",
    seoDescription:
      "Commanding, devoted, completely fixated. Original alpha-male AI roleplay characters \u2014 spicy slow-burn, suggestive only.",
    intro:
  ...
  "arranged-marriage": {
    ...
    seoTitle: "Arranged-Marriage AI Roleplay Characters",
    seoDescription:
      "Political bonds, dynastic politics, and slow thaw. Original arranged-marriage AI roleplay characters \u2014 spicy slow-burn.",
    intro:
      "The contract is signed. Now you both have to live with it. These arranged-marriage stories put two strangers under the same roof and let the rest happen in the way only AI roleplay can \u2014 carefully, deliberately, one thawed silence at a time.",
  },
  "forbidden-love": {
    slug: "forbidden-love",
    label: "Forbidden Love",
    seoTitle: "Forbidden-Love AI Roleplay Characters",
    seoDescription:
      "Crossing every line your world was built on. Original forbidden-love AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  modern: {
    slug: "modern",
    label: "Modern",
    seoTitle: "Modern AI Roleplay Characters",
    seoDescription:
      "Same world, no magic. Modern slow-burn AI roleplay characters with tension, longing, and second chances \u2014 spicy but never explicit.",
    intro:
  ...
  historical: {
    slug: "historical",
    label: "Historical",
    seoTitle: "Historical AI Roleplay Characters",
    seoDescription:
      "Roman frontiers, Norsewood sagas, Al-Andalus alchemy. Original historical AI roleplay characters \u2014 spicy slow-burn.",
    intro:
      "Time periods chosen for the texture, not the textbook. These historical AI roleplay stories live in centurion camps, alchemists' workshops, frozen-sea crossings, and shipwreck shores \u2014 with the politics, language, and danger of each era left intact.",
  },
  magic: {
    slug: "magic",
    label: "Magic",
    seoTitle: "Magic AI Roleplay Characters",
    seoDescription:
      "Witches, alchemists, ash revenants, sixth elements. Original magic-driven AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  "second-chance": {
    slug: "second-chance",
    label: "Second Chance",
    seoTitle: "Second-Chance AI Roleplay Characters",
    seoDescription:
      "What you'd say if you got one more day. Original second-chance AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  tsundere: {
    slug: "tsundere",
    label: "Tsundere",
    seoTitle: "Tsundere AI Roleplay Characters",
    seoDescription:
      "Cold on the surface, devoted underneath. Original tsundere AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  professor: {
    slug: "professor",
    label: "Professor",
    seoTitle: "Professor AI Roleplay Characters",
    seoDescription:
      "After-hours offices, marginal notes, slow conversations. Original professor AI roleplay characters \u2014 spicy slow-burn.",
    intro:
  ...
  billionaire: {
    slug: "billionaire",
    label: "Billionaire",
    seoTitle: "Billionaire AI Roleplay Characters",
    seoDescription:
      "Helicopters, rooftops, high-stakes dares. Original billionaire AI roleplay characters \u2014 spicy slow-burn, suggestive only.",
    intro:
  ...
  "choose-your-own-adventure": {
    ...
    seoTitle: "Choose-Your-Own-Adventure AI Roleplay Stories",
    seoDescription:
      "Branching AI roleplay stories where every choice shapes the plot, alliances, and romance. Original CYOA AI characters \u2014 spicy slow-burn.",
    intro:
