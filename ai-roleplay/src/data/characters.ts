...
export const FEATURED_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    hook: "The syndicate lord who owns the quarter like gravity owns the ground — feared by everyone, tender only for you.",
    imageUrl: "/ai-roleplay/characters/silas-corvane.webp",
    chatUrl: "https://ourdream.ai/chat/silas-corvane-PLACEHOLDER",
    gate: {
      headline: "Silas doesn't repeat himself.",
